...
(3, 'blogname', 'hyospark', 'yes'),
(4, 'blogdescription', '다른 워드프레스 사이트', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', 'hyospark@student.42seoul.kr', 'yes'),
...
(1, 'hyospark', '$P$BrZPBY1YMzdgZdTNVIhGfL0MOYJRuo/', 'hyospark', 'hyospark@student.42seoul.kr', 'https://localhost/wordpress', '2021-09-28 09:35:07', '', 0, 'alal'),
(2, 'hyospark2', '$P$BltOA1vaPoEW7JWcaSGczUBglGwkMQ/', 'hyospark2', 'hyspark@naver.com', '', '2021-09-28 09:35:48', '1632821748:$P$BMYRsp5rfZExPZzdNJkqgMmjRPDtHv/', 0, 'alal2');
